...
export default class Floor {
  ...
  setCircles() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: 0xffb8a7 });
    const material2 = new THREE.MeshStandardMaterial({ color: 0xa8b2e2 });
    const material3 = new THREE.MeshStandardMaterial({ color: 0x6ffacc });
    ...
    this.circleThird.position.y = -0.16;
    this.circleThird.position.x = 0;
